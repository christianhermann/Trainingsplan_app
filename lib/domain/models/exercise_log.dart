...
class ExerciseLog {
  ...
  /// Null when the user has not yet recorded the last-set rep count.
  /// Progression is skipped for this exercise if null.
  ...
  @override
  String toString() =>
      'ExerciseLog(id: $id, prescriptionId: $prescriptionId, '
      'completedSets: $completedSets, repsOnLastSet: $repsOnLastSet, '
      'notes: $notes, videoUrl: $videoUrl, completedAt: $completedAt)';
}
